...
5. Write or update `stage-result.md` and `validator-report.md` in Markdown.
6. If required upstream context is missing or contradictory, raise a question instead of inventing assumptions.
7. Keep the output useful for downstream execution rather than merely well-formatted.
