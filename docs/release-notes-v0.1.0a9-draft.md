...
Latest accepted published prerelease: `0.1.0a9`.

## Summary

This prerelease rolled up post-`v0.1.0a8` operator beta-hardening and release readiness
work while keeping the alpha support stance. It added stronger real-provider UI evidence,
...
- Release workflow:
  `https://github.com/GrinRus/ai_driven_dev_v2/actions/runs/26969522555`.
