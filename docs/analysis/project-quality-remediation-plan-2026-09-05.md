...
The queue and roadmap now record W49-E3-S1, `W49-E3-S2-T1`, and `W49-E3-S2-T2` completion and
promote `W49-E3-S2-T3` as the next dependency-ready task; future promotions must continue through
the same per-task delivery loop.
