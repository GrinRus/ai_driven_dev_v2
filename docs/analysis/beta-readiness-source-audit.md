...
- The latest accepted published prerelease evidence is `0.1.0a17`.
- The source development package version matches the package state: `0.1.0a18.dev0`.
...
- Accepted `0.1.0a17` release/install evidence exists from the published GitHub Release,
  PyPI publish, `pipx` verification, and `uv tool` verification on 2026-08-04.
