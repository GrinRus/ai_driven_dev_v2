...
- Accepted `0.1.0a13` release/install evidence exists from the published GitHub Release,
  PyPI publish, `pipx` verification, and `uv tool` verification on 2026-06-30.
