...
- The source development package version matches the package state: `0.1.0a13.dev0`.
- The latest accepted published prerelease evidence is `0.1.0a12`.
- The source development checkout is not package-channel evidence until a future GitHub
...
- Accepted `0.1.0a12` release/install evidence exists from the published GitHub Release,
