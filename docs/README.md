...
The documentation tree contains current guides, contracts, scenario definitions, and the latest
accepted package-release evidence. New run evidence belongs in its generated evaluation bundle.
