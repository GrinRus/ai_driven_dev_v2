# Provider-Free Packaged UI Browser Gate — 2026-08-01 Post-T71

This is the sanitized `provider-free-browser-pass-v1` record for the post-T71
...
- Source commit: `ef38a3fb22837b7439da231c9b624cc18847bb34`
- Source tree: `944906bfb1cdcb194b41f3f6cc5318b9208d3bc4`
- Playwright: `1.61.0`
...
1. The exact four historical race cases passed `4/4` in `114.91s`.
2. The complete intervention and terminal families passed `24/24` in `585.43s`
...
3. `uv run --extra dev python scripts/run_packaged_ui_scenarios.py` discovered
   ...
   passed in summed `1834.28s`. Runtime/validation Recovery passed `9/9`,
   intervention passed `14/14`, and the final Inbox journey passed `9/9`.
4. `uv run --extra dev pytest -q browser_tests` passed `188/188` in `2422.40s`.
