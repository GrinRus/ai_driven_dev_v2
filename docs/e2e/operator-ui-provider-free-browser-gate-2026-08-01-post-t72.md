# Provider-Free Packaged UI Browser Gate — 2026-08-01 Post-T72

This is the sanitized `provider-free-browser-pass-v1` record for the post-T72
...
- Source commit: `bb465ea33d5ab45af4710ded7004adffb7220ec0`
- Source tree: `6d435445930a316d779767eceea966a3c08ab9e9`
- Playwright: `1.61.0`
...
1. The exact four historical race cases passed `4/4` in `67.48s`.
2. The complete intervention and terminal families passed `24/24` in `297.36s`
...
3. `uv run --extra dev python scripts/run_packaged_ui_scenarios.py` discovered
   ...
   passed in summed `1451.49s`. Runtime/validation Recovery passed `9/9`,
   intervention passed `14/14`, and the final Inbox journey passed `9/9`.
4. `uv run --extra dev pytest -q browser_tests` passed `188/188` in `2457.28s`.
