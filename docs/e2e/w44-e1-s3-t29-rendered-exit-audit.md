...
| 07 | Validation Repair | Partial | Finding, source document, heading map, repair consequence, Runner readiness, and one repair action are co-visible. The current reader/finding layout remains denser and less balanced than the target three-region recovery composition. | `W44-E1-S3-T33` |
