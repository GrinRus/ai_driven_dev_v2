# Wave 36 Candidate Readiness — 2026-07-29 Post-T69

This is the sanitized `candidate-readiness-v1` record for the provider-free
`W36-E7-S4-T37` gate after the T69 run-owned uv tool correction. It contains no
credentials, credential digests, provider output, mutable target content,
...
- Source commit: `5cb58f345631c0398264e5cfcabb6f6dcf2ef0e7`
- Source tree: `90953e1062ded2fee82ebb106e6b3a2e754ff02d`
- Tracked-index SHA-256: `cfbf294aea5e83981e6c883acf573ea08a6ae230128dba162320a4272ff8eb93`
- Tracked-bytes SHA-256: `d32258b3274df50c224339c2d690466b36a82d62e692c01bfd327c7d4734770f`
- Source archive SHA-256: `349fc3e1a7f9e63edc028e57d8d336fcc9eee9a83373902769fba4af446f4724`
- Wheel: `ai_driven_dev_v2-0.1.0a16.dev0-py3-none-any.whl`
- Wheel size: `902430` bytes
- Wheel SHA-256: `a7e72c1a312fd4d3ed1288a3ec245e292f1eb01fd2e0015a5b4a7c0201972196`
...
| Full Python suite | pass, `2147/2147` in `769.91s` |
| Exact-SHA full Chromium suite | pass, `188/188` in `1635.91s` |
...
The first exact-SHA Chromium attempt was rejected after transient host/browser
saturation produced three unrelated readiness/launch timeouts following 39
passes. No source or timeout changed. The exact three cases passed `3/3`
independently, their ordered 37-case predecessor passed `37/37`, and a new
uninterrupted complete suite passed `188/188`. No browser or UI process remained
...
- Fresh clone: pass
- Setup: `bun install --frozen-lockfile`, exit `0`
...
and completed before any provider allocation.
...
remained successful after the mutable target and source roots were removed.

- Bundle tree SHA-256: `3a629a66fecbd10688835800e410581f847e58ea379fcf69021ba327fa2ccaa7`
...
Postflight found the same commit, tree, tracked bytes, tracked file count (`892`),
