# Provider-Free Packaged UI Browser Gate — 2026-07-28

This is the sanitized `provider-free-browser-pass-v1` record for the post-T61
...
- Source commit: `21c12ede16e1c349e8b947b9f6eaa91b9384e806`
- Source tree: `7185fbd465c10ec65fd9c87a3b9ac9b615c4718b`
- Playwright: `1.61.0`
...
1. The exact four historical race cases passed `4/4` in `80.71s`.
2. The complete intervention and terminal families passed `24/24` in `342.98s`
...
3. `uv run --extra dev python scripts/run_packaged_ui_scenarios.py` discovered
   ...
   passed in `2092.71s`. Recovery journey `W36-E7-S1-T3` passed `9/9`; historical
   intervention journey `W36-E7-S1-T10` passed `14/14`.
4. `uv run --extra dev pytest -q browser_tests` passed `188/188` in `2720.11s`.
