# Provider-Free Packaged UI Browser Gate — 2026-07-29 Post-T68

This is the sanitized `provider-free-browser-pass-v1` record for the post-T68
...
- Source commit: `cb12e5b4cc91ce91fd88a65af5f0b5a3a925848b`
- Source tree: `6d26af7dea02453379ccf619848867226053832c`
- Playwright: `1.61.0`
...
1. The exact four historical race cases passed `4/4` in `156.57s`.
2. The complete intervention and terminal families passed `24/24` in `822.19s`
...
3. `uv run --extra dev python scripts/run_packaged_ui_scenarios.py` discovered
   ...
   passed in `2149.14s`. Runtime/validation Recovery passed `9/9`, active Studio
   passed `5/5`, and intervention passed `14/14`.
4. `uv run --extra dev pytest -q browser_tests` passed `188/188` in `2861.70s`.
