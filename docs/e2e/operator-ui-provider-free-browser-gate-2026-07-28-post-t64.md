# Provider-Free Packaged UI Browser Gate — 2026-07-28 Post-T64

This is the sanitized `provider-free-browser-pass-v1` record for the final post-T64
...
- Source commit: `143cc1e9741f08a2756a27a8b24bdc5f52a152f7`
- Source tree: `2efec8e7576dc055c157f91f726e3602ecb47ae2`
- Playwright: `1.61.0`
...
1. The exact four historical race cases passed `4/4` in `79.62s`.
2. The complete intervention and terminal families passed `24/24` in `351.27s`
...
3. `uv run --extra dev python scripts/run_packaged_ui_scenarios.py` discovered
   ...
   passed in `2099.53s`. Recovery journey `W36-E7-S1-T3` passed `9/9`;
   intervention journey `W36-E7-S1-T10` passed `14/14`.
4. `uv run --extra dev pytest -q browser_tests` passed `188/188` in `2662.12s`.
