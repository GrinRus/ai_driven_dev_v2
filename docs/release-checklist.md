...
The accepted `v0.1.0a23` evidence log entry will be added after publication and verification.
...
carries `0.1.0a23`; `main` returns to a `.dev0` version in the post-release follow-up. Keep only
