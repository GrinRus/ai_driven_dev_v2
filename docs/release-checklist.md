...
- Tag: `v0.1.0a25`
- Release branch: `release/v0.1.0a25`
- Commit: `af7812f714e2ad2071756bd796674dd7f340e98f`
- GitHub Release: `https://github.com/GrinRus/ai_driven_dev_v2/releases/tag/v0.1.0a25`
- Release PR: `https://github.com/GrinRus/ai_driven_dev_v2/pull/693` (merged).
- Workflow run: `https://github.com/GrinRus/ai_driven_dev_v2/actions/runs/35860325402`
...
- Build evidence: the release tag matched `project.version` `0.1.0a25`, and the tag commit
  matched the remote `release/v0.1.0a25` branch HEAD.
- PyPI output: `https://pypi.org/project/ai-driven-dev-v2/0.1.0a25/`.
- Independent local `pipx` verification installed the published package using the `pip` backend
  with pipx 1.17.1 and Python 3.13.7; the installed `aidd` binary returned `aidd 0.1.0a25` and
  `aidd doctor` completed successfully.
- Independent local `uv tool` verification used uv 0.12.8 to install
  `ai-driven-dev-v2==0.1.0a25`; the installed `aidd` binary returned `aidd 0.1.0a25` and
  `aidd doctor` completed successfully.
- No Docker/GHCR artifact was published.

### `v0.1.0a24` accepted evidence on 2026-09-22

- Tag: `v0.1.0a24`
- Release branch: `release/v0.1.0a24`
- Commit: `95e457e6f30c8f03c163e00174849ce88ce44ffe`
- GitHub Release: `https://github.com/GrinRus/ai_driven_dev_v2/releases/tag/v0.1.0a24`
- Workflow run: `https://github.com/GrinRus/ai_driven_dev_v2/actions/runs/35671164113`
- Result: accepted published prerelease and package-channel evidence.
- Job results: `quality` passed on Python 3.12, 3.13, and 3.14; `build` passed;
  `publish-pypi` passed; `verify-pypi-install` passed; `verify-uv-tool-install` passed.
- Build evidence: the release tag matched `project.version` `0.1.0a24`, and the tag commit
  matched the remote `release/v0.1.0a24` branch HEAD.
- PyPI output: `https://pypi.org/project/ai-driven-dev-v2/0.1.0a24/`.
- Independent local `pipx` verification used an isolated pipx environment with the `pip`
  backend; the installed `aidd` binary returned `aidd 0.1.0a24` and `aidd doctor` completed
  successfully.
- Independent local `uv tool` verification installed `ai-driven-dev-v2==0.1.0a24`; the installed
  `aidd` binary returned `aidd 0.1.0a24` and `aidd doctor` completed successfully.
- No Docker/GHCR artifact was published.
...
- Commit: `88951f36d266acf6937807757f4e559e5e44a007`
- GitHub Release: `https://github.com/GrinRus/ai_driven_dev_v2/releases/tag/v0.1.0a22`
- Workflow run: `https://github.com/GrinRus/ai_driven_dev_v2/actions/runs/34874926414`
- Result: accepted published prerelease and package-channel evidence.
- Job results: `quality` passed on Python 3.12, 3.13, and 3.14; `build` passed;
  `publish-pypi` passed; `verify-pypi-install` passed; `verify-uv-tool-install` passed.
- Build evidence: the release tag matched `project.version` `0.1.0a22`, and the tag commit
  matched the remote `release/v0.1.0a22` branch HEAD.
- PyPI output: `https://pypi.org/project/ai-driven-dev-v2/0.1.0a22/`.
- Independent local `pipx` verification used an isolated `uv tool run --from pipx` runner with
  the `pip` backend and Python 3.14; the installed `aidd` binary returned `aidd 0.1.0a22` and
  `aidd doctor` completed successfully.
- Independent local `uv tool` verification installed `ai-driven-dev-v2==0.1.0a22`; the installed
  `aidd` binary returned `aidd 0.1.0a22` and `aidd doctor` completed successfully.
- No Docker/GHCR artifact was published.
