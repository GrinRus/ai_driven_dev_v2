...
def test_orchestration_reexports_canonical_frontend_probe_surface() -> None:
    ...
    assert (
        orchestration._frontend_probe_semantic_failure is frontend.frontend_probe_semantic_failure
    )
    assert (
        orchestration._frontend_operator_surface_checks is frontend.frontend_operator_surface_checks
    )
...
def test_orchestration_uses_one_frontend_probe_owner() -> None:
    ...
    assert "_frontend_probe_semantic_failure = _frontend_probe_semantic_failure_extracted" in source
    assert (
        "_frontend_operator_surface_checks = _frontend_operator_surface_checks_extracted" in source
    )
