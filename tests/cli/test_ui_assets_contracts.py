...
def test_studio_history_uses_typed_frames_without_runtime_mutation() -> None:
    ...
    responsive = _asset_text("/operator-responsive.css")
    cockpit = _asset_text("/operator-stage-cockpit.js")
    active_studio = _asset_text("/operator-active-studio.js")
    main = _asset_text("/operator-main.js")
    ...
    _assert_contains_all(
        ...
        (
            ...
            "data-history-run-list",
            "data-history-filter=",
            "data-history-run=",
            "data-history-attempt-details",
            "Input hash:",
            "Output hash:",
            "Copy id:",
            "timeline.frames",
...
def test_operator_artifact_asset_keeps_document_and_truncation_contracts() -> None:
    ...
    _assert_contains_all(
        ...
        (
            ...
            "Document navigator",
            'data-document-role-group="${escapeHtml(role)}"',
            "Bounded / truncated",
            "Permission denied",
            "data-reader-next-action",
            "Copy path",
            ...
            "${renderMarkdownWithReaderAnchors(view.text)}",
...
def test_operator_recovery_assets_prioritize_eligible_runtime_retry() -> None:
    ...
    _assert_contains_all(
        ...
        (
            ...
            "function renderRecoveryDecisionWorkbench({",
            'data-recovery-mode="${mode}"',
            "data-recovery-decisive-signal",
            "data-recovery-evidence",
            "data-recovery-consequence",
            "Runtime retry is separate from validation repair attempts.",
            "Retry does not consume validation repair budget",
...
def test_task_workspace_attempt_tray_preserves_factual_live_state() -> None:
    studio = _asset_text("/operator-active-studio.js")
    logs = _asset_text("/operator-logs-jobs.js")
