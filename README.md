...
Current source development package version on this branch: `0.1.0a6.dev0`.
...
The latest accepted published prerelease evidence is `v0.1.0a5`. This source checkout now
carries the post-release development version `0.1.0a6.dev0`; future release candidates must
again pass GitHub Release, PyPI publish, `pipx`, and `uv tool` verification before they are
accepted.
