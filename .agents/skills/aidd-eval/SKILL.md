...
5. the selected scenario under `harness/scenarios/`
6. `.agents/skills/aidd-eval/references/e2e-flow-audit.md`
...
7. Run graders.
8. Run log analysis.
9. Write the final audit artifacts.
10. Report the final verdict with explicit failure classification.
...
Status: <pass|document_fail|model_fail|env_fail|permission_fail|auth_fail|timeout|adapter_fail|harness_fail|needs_user_input>
