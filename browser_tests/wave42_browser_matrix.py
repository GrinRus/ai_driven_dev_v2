...
WAVE42_BROWSER_JOURNEYS: tuple[Wave42BrowserJourney, ...] = (
    ...
    Wave42BrowserJourney(
        ...
        surface_selector='[data-human-decision-surface="question"]',
        first_action_selector='[data-human-decision-surface="question"] [data-primary-action]',
    ...
    Wave42BrowserJourney(
        ...
        surface_selector=".validation-repair-center",
    ...
    Wave42BrowserJourney(
        ...
        first_action_selector=(
            '[data-studio-quality-gate="review"] [data-remediation-launch="review"]'
        ),
